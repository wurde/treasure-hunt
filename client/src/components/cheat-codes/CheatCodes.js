...
function CheatCodes({ generateMovementMessage }) {
  async function askTravelTo() {
    const roomID = window.prompt("Room ID:");

    generateMovementMessage(roomID);
  ...
  return (
    <div className="CheatCodes pannel mb-4">
      ...
      <div class="p-2">
        ...
        <button
          onClick={e => travelTo(1)}
          className="m-1 btn btn-sm btn-primary"
        >
          Go To Shop
        </button>
        <button
          onClick={e => travelTo(467)}
          className="m-1 btn btn-sm btn-primary"
        >
          Go To Pirate Ry's
        </button>
        <button
          onClick={e => travelTo(495)}
          className="m-1 btn btn-sm btn-primary"
        >
